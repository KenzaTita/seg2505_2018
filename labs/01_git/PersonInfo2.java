public class PersonInfo2 {
    ...
    public static String firstName = "Myriam";
    public static String lastName = "Villeneuve";
    public static int studentNo = 8134271;
    public static String description = "Blabla";
